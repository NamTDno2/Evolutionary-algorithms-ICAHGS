...
# Main comparison
result_dir = 'result_maxiter_high'
...
print("=== COMPARISON: HIGH ITERATIONS vs BENCHMARK ===")
print("50C: 50 iterations | 100C: 100 iterations\n")
...
print("\nFor 50C:")
print("  maxIteration=12:    43.8% win rate ✅ BASELINE")
print(f"  maxIteration=50:    {win_rate_50c:.1f}% win rate ← NEW TEST")
print("  maxEval 1.095M/20M: 25.0% win rate")
print("  maxEval 105K (5x):  12.5% win rate")
print("  maxEval 210K (10x): 12.5% win rate")

print("\nFor 100C:")
print("  maxIteration=25:    12.5% win rate ✅ BASELINE")
print(f"  maxIteration=100:   {win_rate_100c:.1f}% win rate ← NEW TEST")
print("  maxEval 1.095M/20M: 12.5% win rate")
print("  maxEval 330K (5x):  12.5% win rate")
...
if win_rate_50c > 43.8:
    print(f"  ✅ 50C IMPROVED: {win_rate_50c:.1f}% > 43.8% (baseline)")
    print("     → More iterations (50) better than baseline (12)")
elif win_rate_50c == 43.8:
    print(f"  ✓ 50C EQUAL: {win_rate_50c:.1f}% = 43.8% (baseline)")
    print("     → No improvement from extra iterations")
else:
    print(f"  ⚠️  50C WORSE: {win_rate_50c:.1f}% < 43.8% (baseline)")
    print("     → More iterations hurt quality (overfitting)")

if win_rate_100c > 12.5:
    print(f"  ✅ 100C IMPROVED: {win_rate_100c:.1f}% > 12.5% (baseline)")
    print("     → More iterations (100) better than baseline (25)")
elif win_rate_100c == 12.5:
    print(f"  ✓ 100C EQUAL: {win_rate_100c:.1f}% = 12.5% (baseline)")
    print("     → No improvement from extra iterations")
else:
    print(f"  ⚠️  100C WORSE: {win_rate_100c:.1f}% < 12.5% (baseline)")
    print("     → More iterations hurt quality (overfitting)")

print("\nRECOMMENDATION:")
if win_rate_50c > 43.8 or win_rate_100c > 12.5:
    print("  Consider using higher iteration counts for improved performance")
else:
    print("  Stick with baseline iteration counts (12/25)")
    print("  Higher iterations don't improve quality - likely overfitting issue")
