...
print("="*80)
print("FINAL COMBINED RESULTS COMPARISON")
print("  20C/200C: maxEvaluation (from result/)")
print("  50C/100C: maxIteration=12/25 (NEW RUN)")
print("="*80)
...
for bench_file in benchmark_files:
    ...
    result_file = f'result_final_combined/{bench_file}'
...
for size in sizes:
    ...
    if total > 0:
        ...
        config_note = 'maxEval (result/)' if size in [20, 200] else 'maxIter=12/25 (NEW)'
...
if overall_total > 0:
    ...
    print("\n" + "="*80)
    print(f"FINAL COMBINED: {overall_wins}/{overall_total} wins = {overall_win_rate:.1f}%")
    print("="*80)
    ...
    print(f"  FINAL COMBINED (this):            {overall_wins}/{overall_total} = {overall_win_rate:5.1f}% win")
